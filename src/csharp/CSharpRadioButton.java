...
public class CSharpRadioButton extends CSharpElement {

    private final String view = "RadioButton";
    private final String text = "RadioButton";
    private boolean checked;

    public CSharpRadioButton(JSONModelCSharp jsonModelCSharp) {
    ...
    public void drawObj(StringBuilder root, CSharpElement element) {
        root.append("        private System.Windows.Forms.RadioButton " + element.getId() + ";\n");
    }
    ...
    public void drawVars(StringBuilder initialize, CSharpElement element) {
        initialize.append("            this." + element.getId() + " = new System.Windows.Forms.RadioButton();\n");
    }
}
